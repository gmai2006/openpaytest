...
public class MisthFyloKratServiceTest {
  private static DefaultMisthFyloKratService serviceMock;
  private static MisthFyloKrat[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultMisthFyloKratService.class);
    ...
    final MisthFyloKratId id =
        new MisthFyloKratId(
            records[0].getKodfylo(), records[0].getKodkrat(), records[0].getKodxrisi());
  ...
  public void testFind_success() {
    final MisthFyloKratId id =
        new MisthFyloKratId(
            records[0].getKodfylo(), records[0].getKodkrat(), records[0].getKodxrisi());
    MisthFyloKrat testResult = serviceMock.find(id);

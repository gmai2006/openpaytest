...
public class MisthZptmimaServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthZptmimaId id =
        new MisthZptmimaId(records[0].getKodxrisi(), records[0].getKodtmima());
  ...
  public void testFind_success() {
    final MisthZptmimaId id =
        new MisthZptmimaId(records[0].getKodxrisi(), records[0].getKodtmima());
    MisthZptmima testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals desctmima ", records[0].getDesctmima(), testResult.getDesctmima());
  }
}

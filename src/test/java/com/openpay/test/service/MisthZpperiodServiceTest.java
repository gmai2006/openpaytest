...
public class MisthZpperiodServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthZpperiodId id =
        new MisthZpperiodId(records[0].getKodxrisi(), records[0].getKodperiod());
  ...
  public void testFind_success() {
    final MisthZpperiodId id =
        new MisthZpperiodId(records[0].getKodxrisi(), records[0].getKodperiod());
    MisthZpperiod testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals descperiod ", records[0].getDescperiod(), testResult.getDescperiod());

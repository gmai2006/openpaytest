...
public class AfxfilterdServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals(
        "expect equals pedio ", records[0].getPedio(), testResult.getPedio());
    org.junit.Assert.assertEquals(
        "expect equals telestis ", records[0].getTelestis(), testResult.getTelestis());
    org.junit.Assert.assertEquals(
        "expect equals timi ", records[0].getTimi(), testResult.getTimi());
    org.junit.Assert.assertEquals(
        "expect equals joint ", records[0].getJoint(), testResult.getJoint());
  }
}

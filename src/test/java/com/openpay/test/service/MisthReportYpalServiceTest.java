...
public class MisthReportYpalServiceTest {
  private static DefaultMisthReportYpalService serviceMock;
  private static MisthReportYpal[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultMisthReportYpalService.class);
    ...
    final MisthReportYpalId id =
        new MisthReportYpalId(
            records[0].getKodxrisi(), records[0].getKodreport(), records[0].getKodypal());
  ...
  public void testFind_success() {
    final MisthReportYpalId id =
        new MisthReportYpalId(
            records[0].getKodxrisi(), records[0].getKodreport(), records[0].getKodypal());
    MisthReportYpal testResult = serviceMock.find(id);

...
public class MisthZptitlosServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthZptitlosId id =
        new MisthZptitlosId(records[0].getKodxrisi(), records[0].getKodtitlos());
  ...
  public void testFind_success() {
    final MisthZptitlosId id =
        new MisthZptitlosId(records[0].getKodxrisi(), records[0].getKodtitlos());
    MisthZptitlos testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals desctitlos ", records[0].getDesctitlos(), testResult.getDesctitlos());
  }
}

...
public class MisthZpstathServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthZpstathId id =
        new MisthZpstathId(records[0].getKodxrisi(), records[0].getKodstath());
  ...
  public void testFind_success() {
    final MisthZpstathId id =
        new MisthZpstathId(records[0].getKodxrisi(), records[0].getKodstath());
    MisthZpstath testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals descstath ", records[0].getDescstath(), testResult.getDescstath());

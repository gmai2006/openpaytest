...
public class MisthZpkatServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthZpkatId id = new MisthZpkatId(records[0].getKodxrisi(), records[0].getKodkat());
  ...
  public void testFind_success() {
    final MisthZpkatId id = new MisthZpkatId(records[0].getKodxrisi(), records[0].getKodkat());
    MisthZpkat testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals desckat ", records[0].getDesckat(), testResult.getDesckat());
  }
}

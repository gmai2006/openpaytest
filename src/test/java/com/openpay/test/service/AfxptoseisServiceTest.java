...
public class AfxptoseisServiceTest {
  ...
  public void testFind_success() {
    ...
    org.junit.Assert.assertEquals("expect equals gen ", records[0].getGen(), testResult.getGen());
    org.junit.Assert.assertEquals("expect equals ait ", records[0].getAit(), testResult.getAit());
  }
}

...
public class MisthFinalServiceTest {
  ...
  public static void setUp() {
    ...
    final MisthFinalId id = new MisthFinalId(records[0].getKodfinal(), records[0].getKodxrisi());
  ...
  public void testFind_success() {
    final MisthFinalId id = new MisthFinalId(records[0].getKodfinal(), records[0].getKodxrisi());
    MisthFinal testResult = serviceMock.find(id);
    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals descfinal ", records[0].getDescfinal(), testResult.getDescfinal());
    org.junit.Assert.assertEquals(
        "expect equals title ", records[0].getTitle(), testResult.getTitle());
    org.junit.Assert.assertEquals(
        "expect equals kodkat ", records[0].getKodkat(), testResult.getKodkat());
    org.junit.Assert.assertEquals(
        "expect equals kodperiod ", records[0].getKodperiod(), testResult.getKodperiod());
  }
}

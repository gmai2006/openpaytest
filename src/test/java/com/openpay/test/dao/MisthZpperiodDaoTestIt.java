...
public class MisthZpperiodDaoTestIt {
  static final String inputFile = "MisthZpperiod.json";
  static MisthZpperiodDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultMisthZpperiodDao(jpa);
  }
  ...
  public void testSelect() {
    final MisthZpperiodId id =
        new MisthZpperiodId(this.records[1].getKodxrisi(), this.records[1].getKodperiod());
    MisthZpperiod testResult = dao.find(id);

...
public class MisthZpkatDaoTestIt {
  static final String inputFile = "MisthZpkat.json";
  static MisthZpkatDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultMisthZpkatDao(jpa);
  }
  ...
  public void testSelect() {
    final MisthZpkatId id =
        new MisthZpkatId(this.records[1].getKodxrisi(), this.records[1].getKodkat());
    MisthZpkat testResult = dao.find(id);

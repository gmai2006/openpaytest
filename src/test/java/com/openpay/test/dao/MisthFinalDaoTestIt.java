...
public class MisthFinalDaoTestIt {
  static final String inputFile = "MisthFinal.json";
  static MisthFinalDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultMisthFinalDao(jpa);
  }
  ...
  public void testSelect() {
    final MisthFinalId id =
        new MisthFinalId(this.records[1].getKodfinal(), this.records[1].getKodxrisi());
    MisthFinal testResult = dao.find(id);

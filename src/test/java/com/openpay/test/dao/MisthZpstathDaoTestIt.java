...
public class MisthZpstathDaoTestIt {
  static final String inputFile = "MisthZpstath.json";
  static MisthZpstathDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultMisthZpstathDao(jpa);
  }
  ...
  public void testSelect() {
    final MisthZpstathId id =
        new MisthZpstathId(this.records[1].getKodxrisi(), this.records[1].getKodstath());
    MisthZpstath testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertEquals(
        "expect equals descstath ", this.records[1].getDescstath(), testResult.getDescstath());

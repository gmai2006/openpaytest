...
import com.openpay.test.dao.DefaultMisthReportColsDao;
...
public class MisthReportColsHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthReportCols.csv");
    ...
    final MisthReportColsId id =
        new MisthReportColsId(
            this.records[0].getKodcol(),
            this.records[0].getKodxrisi(),
            this.records[0].getKodreport());
    MisthReportCols testResult = jpa.find(MisthReportCols.class, id);

...
import com.openpay.test.dao.DefaultMisthZpyvarDao;
...
public class MisthZpyvarHandlerTestIt {
  static final String inputFile = "MisthZpyvar.json";
  static MisthZpyvarHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthZpyvar.csv");
    ...
    final MisthZpyvarId id =
        new MisthZpyvarId(this.records[0].getKodyvar(), this.records[0].getKodxrisi());
    MisthZpyvar testResult = jpa.find(MisthZpyvar.class, id);
    assertEquals(

...
import com.openpay.test.dao.DefaultMisthFinalYpalKratDao;
...
public class MisthFinalYpalKratHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthFinalYpalKrat.csv");
    ...
    final MisthFinalYpalKratId id =
        new MisthFinalYpalKratId(
            this.records[0].getKodfinal(),
            this.records[0].getKodkrat(),
            this.records[0].getKodxrisi(),
            this.records[0].getKodypal());
    MisthFinalYpalKrat testResult = jpa.find(MisthFinalYpalKrat.class, id);

...
import com.openpay.test.dao.DefaultAfxfilterDao;
...
public class AfxfilterHandlerTestIt {
  static final String inputFile = "Afxfilter.json";
  static AfxfilterHandler handler;
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/Afxfilter.csv");

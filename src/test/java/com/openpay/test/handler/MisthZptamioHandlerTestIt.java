...
import com.openpay.test.dao.DefaultMisthZptamioDao;
...
public class MisthZptamioHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthZptamio.csv");
    ...
    final MisthZptamioId id =
        new MisthZptamioId(this.records[0].getKodtamio(), this.records[0].getKodxrisi());
    MisthZptamio testResult = jpa.find(MisthZptamio.class, id);
    assertEquals(

...
import com.openpay.test.dao.DefaultMisthFyloKratDao;
...
public class MisthFyloKratHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthFyloKrat.csv");
    ...
    MisthFyloKrat testResult = jpa.find(MisthFyloKrat.class, id);

...
import com.openpay.test.dao.DefaultMisthFyloYpalDao;
...
public class MisthFyloYpalHandlerTestIt {
  ...
  public void testSelect() throws IOException {
    final File tempFile = new File("./src/test/resources/MisthFyloYpal.csv");
    ...
    final MisthFyloYpalId id =
        new MisthFyloYpalId(
            this.records[0].getKodfylo(),
            this.records[0].getKodxrisi(),
            this.records[0].getKodypal());
    MisthFyloYpal testResult = jpa.find(MisthFyloYpal.class, id);

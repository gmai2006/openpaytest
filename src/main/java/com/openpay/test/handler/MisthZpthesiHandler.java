...
// @Stateless
@Named("MisthZpthesiHandler")
public class MisthZpthesiHandler extends DelimiterFileHandler<MisthZpthesi> {

  @Inject
  @Named("DefaultJpaDao")
  public MisthZpthesiHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected MisthZpthesi parseLine(List<String> headers, List<String> tokens) {

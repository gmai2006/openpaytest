  ...
  protected MisthZpkrat parseLine(List<String> headers, List<String> tokens) {
    ...
    for (int i = 0; i < tokens.size(); i++) {
      switch (headers.get(i)) {
        ...
        case "isforos":
          record.setIsforos(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "isasf":
          record.setIsasf(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "isautoforos":
          record.setIsautoforos(java.lang.Integer.valueOf((tokens.get(i))));
          break;

...
// @Stateless
@Named("MisthZpoikogHandler")
public class MisthZpoikogHandler extends DelimiterFileHandler<MisthZpoikog> {

  @Inject
  @Named("DefaultJpaDao")
  public MisthZpoikogHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected MisthZpoikog parseLine(List<String> headers, List<String> tokens) {

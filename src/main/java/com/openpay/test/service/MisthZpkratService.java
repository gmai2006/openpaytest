...
public interface MisthZpkratService {
  public MisthZpkrat find(MisthZpkratId id);
  /**
   * Select a list of MisthZpkrat based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return MisthZpkrat records.
   */
  public List<MisthZpkrat> select(int maxResult);

  /**
   * Select all MisthZpkrat.
   *
   * @return all MisthZpkrat records.
   */

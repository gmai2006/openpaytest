...
public interface AfxkeygenService {
  public Afxkeygen find(java.lang.String id);

  /**
   * Select a list of Afxkeygen based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return Afxkeygen records.
   */
  public List<Afxkeygen> select(int maxResult);

  /**
   * Select all Afxkeygen.
   *
   * @return all Afxkeygen records.
   */
